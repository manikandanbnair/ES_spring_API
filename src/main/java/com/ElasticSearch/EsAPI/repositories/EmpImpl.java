...
public class EmpImpl implements EmployeeManagerCustomRepository {
    ...
    @Override
    public List<EmployeeManagerModel> getEmployeesByManagerIdAndJoiningDate(String managerId, OffsetDateTime dateOfJoining) {
    ...
    public List<EmployeeManagerModel> findByDepartment(String department) {
        return employeeManagerRepository.findByDepartment(department);
    }
